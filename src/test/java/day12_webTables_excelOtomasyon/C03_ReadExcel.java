...
public class C03_ReadExcel {
    ...
    public void test01() throws IOException {
        ...
        // bilgisayarimizda olan bir dosyaya erisebilmek icin FileInputStrem Class'indan obje olusturalim
        String dosyaiyolu = System.getProperty("user.dir")+"/src/test/java/day12_webTables_excelOtomasyon/ulkeler.xlsx";

        FileInputStream fis = new FileInputStream(dosyaiyolu);
        ...
        // Assert.assertEquals(expectedData,cell);
